  ...
  return (
    <div className="page-section">
      <div className="page-header">
        <h2 className="section-title">Bảng KPI</h2>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 mb-5">
        ...
        <div className="wrs-card p-5">
          <StatHighlight value={dashboard.activeShipments || 0} label="Phiếu xuất đang xử lý" color="text-blue-600" bgColor="bg-blue-50" />
        </div>
        <div className="wrs-card p-5">
          <div className="flex items-center gap-4">
            <StatHighlight value={dashboard.inboundToday || 0} label="Nhập hôm nay" color="text-emerald-600" bgColor="bg-emerald-50" className="flex-1" />
          </div>
        </div>
        <div className="wrs-card p-5 flex flex-col gap-3">
          <StatHighlight value={dashboard.pendingBillingEvents || 0} label="Tính phí chờ" color="text-amber-600" bgColor="bg-amber-50" />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-4">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-moon-200">
                  ...
                  <th className="text-right py-2 text-navy-500 font-medium">Phiếu xuất</th>
                  <th className="text-right py-2 text-navy-500 font-medium">Còn nợ</th>
                </tr>
              </thead>
              <tbody>
                {kpiByOwner.map((row) => (
        ...
        {/* Movement Trend */}
        <div className="wrs-card p-5">
          <h3 className="text-sm font-semibold text-navy-900 mb-3">Xu hướng lưu chuyển (7 ngày)</h3>
          <TrendMiniChart
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="wrs-card p-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-semibold text-navy-900">Sử dụng kho</p>
            <p className="text-xs text-navy-400">Mức sử dụng công suất hiện tại</p>
          </div>
        </div>
        <div className="wrs-card p-5 flex items-center gap-4">
          <ProgressRing value={dashboard.reconPassRate || 0} max={100} color="#059669" label="Tỷ lệ đạt" />
          <div>
            <p className="text-sm font-semibold text-navy-900">Tỷ lệ đạt RECON-001</p>
