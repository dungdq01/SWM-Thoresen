  ...
  return (
    <div className="page-section">
      <div className="page-header">
        <h2 className="section-title">Danh sách Go-Live — 12 cổng</h2>
      ...
      {readyForGoLive ? (
        <div className="bg-emerald-50 border border-emerald-300 rounded-lg p-4 mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-emerald-700">Tất cả {gates.length} cổng đã PASS hoặc bỏ qua. Hệ thống sẵn sàng đưa vào production.</p>
          </div>
        </div>
      ) : (
        <div className="bg-rose-50 border border-rose-300 rounded-lg p-4 mb-5 flex items-center gap-3">
          <span className="text-2xl">🚫</span>
          <div>
            <p className="font-bold text-rose-800">CHƯA SẴN SÀNG — {failCount} cổng còn FAIL</p>
            <p className="text-sm text-rose-700">Hoàn thành tất cả cổng hoặc bỏ qua với lý do trước khi go-live.</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        <div className="wrs-card p-3 text-center">
          ...
          <p className="text-xs text-navy-500">Tổng cổng</p>
        </div>
        <div className="wrs-card p-3 text-center">
      ...
      {/* Gates by Category */}
      {isLoading ? (
        <div className="wrs-card p-8 text-center text-navy-400 text-sm">Đang tải cổng...</div>
      ) : (
