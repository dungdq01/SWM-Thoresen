    ...
    <>
      ...
      <div className="wrs-card p-5 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {[{ value: '', label: 'Tất cả' }, { value: 'CREATED', label: 'CREATED' }, { value: 'RELEASED', label: 'RELEASED' }, { value: 'COUNTING', label: 'COUNTING' }, { value: 'UNDER_REVIEW', label: 'UNDER_REVIEW' }, { value: 'APPROVED', label: 'APPROVED' }, { value: 'POSTED', label: 'POSTED' }].map((s) => (
            <button
              key={s.value}
