...
function OcrCard({ row, isSelected, onClick }) {
  ...
  const timeStr = time ? time.toLocaleString('vi-VN', { hour: '2-digit', minute: '2-digit', day: '2-digit', month: '2-digit' }) : '—'
  ...
  return (
    ...
    >
      {/* Top row: status + time + confidence */}
