...
export const authApi = {
  ...
  assignPermissionToRole: (roleId, data) => httpClient.post(`/foundation/roles/${roleId}/permissions`, data),
  deleteRole: (id) => httpClient.delete(`/foundation/roles/${id}`),
  getPermissions: (params) => httpClient.get('/foundation/permissions', { params }),
  createPermission: (data) => httpClient.post('/foundation/permissions', data),
  updatePermission: (id, data) => httpClient.put(`/foundation/permissions/${id}`, data),
  deletePermission: (id) => httpClient.delete(`/foundation/permissions/${id}`),
  assignRoleToUser: (userId, data) => httpClient.post(`/foundation/users/${userId}/roles`, data),
