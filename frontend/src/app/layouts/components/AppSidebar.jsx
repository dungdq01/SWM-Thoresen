    ...
    items: [
      {
        ...
        children: [
          ...
          { to: '/app/master-data/customers', label: t('sidebar.items.customers'), icon: Users },
          ...
          { to: '/app/master-data/uom-conversions', label: t('sidebar.items.uomConversions'), icon: ArrowRightLeft },
