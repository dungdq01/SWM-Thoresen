...
const permissionSeeds: Array<[string, string, string, string, boolean]> = [
  ...
  ['master_data.rack.view', 'MASTER_DATA', 'RACK', 'VIEW', false],
  ['master_data.rack.create', 'MASTER_DATA', 'RACK', 'CREATE', true],
  ['master_data.rack.update', 'MASTER_DATA', 'RACK', 'UPDATE', true],
  ['master_data.rack.deactivate', 'MASTER_DATA', 'RACK', 'DEACTIVATE', true],
