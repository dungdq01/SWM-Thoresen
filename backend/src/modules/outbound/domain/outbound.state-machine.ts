...
export const SHIPMENT_TRANSITIONS: StateTransition[] = [
  ...
  { from: ShipmentStatus.WEIGHING_1, to: ShipmentStatus.WEIGHING_2, action: 'RECORD_GROSS_WEIGHT' },
  ...
  { from: ShipmentStatus.WEIGHING_2, to: ShipmentStatus.WEIGHED, action: 'RECORD_TARE_WEIGHT' },
  { from: ShipmentStatus.WEIGHING_2, to: ShipmentStatus.ALLOCATED, action: 'ALLOCATE' },
  { from: ShipmentStatus.WEIGHING_2, to: ShipmentStatus.CANCELLED, action: 'CANCEL' },
  { from: ShipmentStatus.WEIGHED, to: ShipmentStatus.ALLOCATED, action: 'ALLOCATE' },
  { from: ShipmentStatus.WEIGHED, to: ShipmentStatus.CANCELLED, action: 'CANCEL' },
